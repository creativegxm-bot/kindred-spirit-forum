      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2">
            {language === "tr" ? "AI uygulama bulunamadı" : "AI App not found"}
          </h1>
          <Button onClick={() => navigate("/ai-apps")} variant="outline">
            <ArrowLeft className="h-4 w-4 mr-2" />
            {language === "tr" ? "AI Uygulamalara Dön" : "Back to AI Apps"}
          </Button>
        </div>
      </div>
    );
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 lg:p-6 max-w-4xl mx-auto">
          ...
          >
            ...
            {language === "tr" ? "Tüm AI Uygulamalar" : "All AI Apps"}
          </Button>
