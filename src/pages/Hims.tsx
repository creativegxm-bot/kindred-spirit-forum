    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <main className="flex-1 max-w-4xl mx-auto px-4 py-4">
          <div className="bg-gradient-to-r from-blue-600/20 to-cyan-500/20 rounded-lg p-6 mb-6 border border-blue-500/30">
            <div className="flex items-center gap-3 mb-2">
              <Shield className="h-8 w-8 text-blue-500" />
              <h1 className="text-2xl font-bold text-foreground">
                {language === "tr" ? "Erkek Sağlığı" : "Hims — Men's Health"}
              </h1>
            </div>
            <p className="text-muted-foreground">
              {language === "tr"
                ? "Erkek sağlığı, fitness, beslenme ve yaşam tarzı hakkında günlük haberler ve tartışmalar."
                : "Daily news and discussions about men's health, fitness, nutrition, and lifestyle."}
            </p>
          </div>
